		...
		<div class="collapse navbar-collapse" id="navbarSupportedContent">
			<ul class="navbar-nav mr-auto">
				...
				<li class="nav-item"><sec:authorize
						...
						<a class="nav-link" href="<c:url value="/admin/stats" />"><spring:message code="label.adminHome"/></a>
					</sec:authorize> <sec:authorize access="hasRole('ROLE_USER')">
						<a class="nav-link" href="<c:url value="/myAccount" />"><spring:message code="label.myAccount"/></a>
					</sec:authorize></li>
				<li class="nav-item"><sec:authorize
						access="!hasRole('ROLE_ADMIN')">
						<a class="nav-link" href="<c:url value="/myCart" />"><spring:message code="label.myCart"/></a>
					</sec:authorize></li>
				<li class="nav-item"><sec:authorize
						access="hasRole('ROLE_USER')">
						<a class="nav-link" href="<c:url value="/orderHistory" />"><spring:message code="label.myOrders"/></a>
					</sec:authorize></li>
