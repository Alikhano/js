...
public class CustomerDaoImpl extends GenericDaoImpl<Customer> implements CustomerDao {
	...
	public List<Customer> getTopCustomers() {
		...
		String hql = "select order.customer, count(*) as purchaseCount from Orders order " +
				"where order.paymentStatus =: paymentStatus GROUP BY order.customer ORDER BY purchaseCount desc";
